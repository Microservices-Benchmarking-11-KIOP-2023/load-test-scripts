...
export let options = {
    scenarios: {
        may: {
            ...
            vus: 100,
            duration: '10s', // run for 5 minutes
            startTime: '0m', // start immediately
            exec: 'testCity',
            env: { MONTH: '05', DAYS: '31' }
        },
        june: {
            executor: 'constant-vus',
            vus: 100,
            duration: '10s', // run for 5 minutes
            startTime: '10s', // start 5 minutes after May scenario
            exec: 'testCity',
            env: { MONTH: '06', DAYS: '30' }
        }
        ,
        july: {
            executor: 'constant-vus',
            ...
            startTime: '2m', // start 5 minutes after June scenario
            exec: 'testCity',
